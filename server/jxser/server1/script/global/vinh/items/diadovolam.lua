...
function nvthontran()
	local Talk = "CÈm nang ®Æc biÖt gióp dÞch chuyÓn nhanh c¸c ®Þa ®iÓm lµm nhiÖm vô Th«n trÊn.\nHoµn thµnh nhiÖm vô, ng­¬i sÏ nhËn ®­îc nh÷ng phÇn th­ëng xøng ®¸ng.\nTruy cËp: <color=green>Youtube: PYTA GAMING<color> ®Ó update."
	local tb = {
...
function villagequest(IDv)
	local MissType = IDv --Loai thon tran
	local tb = {
...
function villagequest_step1(ID1,ID2)
	local MissType = ID1 --Loai Thon Tran
	local PheType = ID2 --loai NV
...
tb_HelpMonPhai = {
	[0] = { --Thieu lam
		...
		[5] = {
			...
			[6] = {"§Õn rõng th«ng t×m DÞch Ch©n Kinh","",1,0,103,231,170},
	...
	[2] = { --Duong Mon
		...
		[8] = {
			...
			[6] = {"GÆp §oan Méc DuÖ","",0,0,49,225,199},
	...
	[6] = { --Cai bang OK
		...
		[8] = {------------------------------------------------------------------------
			...
			[7] = {"Cøu ®­îc Giíi V« Tµ, quay vÒ gÆp La Khu«ng Sinh, hoµn thµnh nhiÖm vô",""},
		},
		[9] = {
			[1] = {"<color=green>BÝ kÝp kü n¨ng cÊp 120 cã thÓ thu thËp t¹i Kú Tr©n C¸c<color>"},
		},
	...
	[7] = { --Thien nhan
		...
		[5] = {
			...
			[11] = {"Trë vÒ gÆp §oan Méc DuÖ, hoµn thµnh nhiÖm vô","",0,1,49,1800,3184},
		},
		[6] = {
			...
			[13] = {"GÆp Hoµn Nhan Hång LiÖt, hoµn thµnh nhiÖm vô","",0,1,49,1721,3129},
		},
		[7] = {
		...
		[8] = { --------------------------------------------------------
			[1] = {"<color=green>NhiÖm vô cÊp 90 Thiªn NhÉn Gi¸o<color><enter>Häc ®­îc vâ c«ng:<enter><color=yellow>B¨ng Tung V« ¶nh<enter>B¨ng Tinh Tiªn Tö<color>"},
			[2] = {"GÆp L­u Viªn Ngo¹i","",0,1},
			[3] = {"GÆp Hoµn Nhan TuyÕt Y","",0,1},
			[4] = {"§¸nh Linh §iªu - Täa ®é 1","",1,1},
			[5] = {"§¸nh Linh §iªu - Täa ®é 2","",1,1},
			[6] = {"Quay l¹i gÆp Hoµn Nhan TuyÕt Y","",0,1},
			[7] = {"Quay l¹i gÆp L­u Viªn Ngo¹i, hoµn thµnh nhiÖm vô","",0,1},
		},
		[9] = {
			[1] = {"<color=green>BÝ kÝp kü n¨ng cÊp 120 cã thÓ thu thËp t¹i Kú Tr©n C¸c<color>"},
		},
		[10] = { -----------------------------------------------------------
			...
			[2] = {"GÆp Thiªn NhÉn gi¸o ®å","",0,1},
			[3] = {"GiÕt §¹i Hoµn Hïng ®o¹t Vò V­¬ng KiÕm","",1,1},
			[4] = {"GiÕt §¹i Hoµn Hïng thø hai lÊy Vò V­¬ng KiÕm thËt","",1,1},
			[5] = {"Quay l¹i gÆp Thiªn NhÉn gi¸o ®å, hoµn thµnh nhiÖm vô","",0,1},
		},
	},
	[8] = { --Vo dang
		[1] = {
...
function help_quest_step1(nFaction,nIDQ,nX,nY)
	...
	for i=nX1,nY1 do
		...
		local TypeMove = tb_HelpMonPhai[nFaction][nIDQ][i][4] --Ban ®Çu m×nh lµm phÇn to¹ ®o¹ lµ kiÓu nh­ game vÝ dô 271 - 291 nh¬ng to¹ ®é nµy nã phï kh«ng chÝnh x¸c nªn vÒ sau ®Ó hÕt sang to¹ ®æ kiÓu 4 sè. TypeMove lu«n lµ 1
...
function helpgoldquest()
    ...
    "20 ChÝnh tuyÕn/#chonLoai(1,1)",
	"20 Phô tuyÕn/#chonLoai(2,1)",

    "30 ChÝnh tuyÕn/#chonLoai(1,2)",
    "30 Phô tuyÕn/#chonLoai(2,2)",

    "40 ChÝnh tuyÕn/#chonLoai(1,3)",
    "40 Phô tuyÕn/#chonLoai(2,3)",
    "50 ChÝnh tuyÕn/#chonLoai(1,4)",
    "50 Phô tuyÕn/#chonLoai(2,4)",

    "60 ChÝnh tuyÕn/#chonLoai(1,5)", 
...
function chonLoai(loai, cap)
    local MissType = ID --Lo¹i nv chÝnh hay phô tuyªn. ChÝnh lµ 1 phô lµ 2
    local tb = {
    "ChÝnh ph¸i/#gquest_step2("..loai..","..cap..",1)",
    "Trung lËp/#gquest_step2("..loai..","..cap..",2)",
    "Tµ ph¸i/#gquest_step2("..loai..","..cap..",3)",
    "Quay l¹i/helpgoldquest",
    "KÕt thóc ®èi tho¹i/Quit"
    }
    Say("",getn(tb),tb)
end
...
function gquest_step2(ID1,ID2,ID3)
    ...
    local CapDo = ID2
    local PheType = ID3 --NhiÖm vô chÝnh - trung - tµ
